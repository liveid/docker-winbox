...
MAINTAINER Tony <Tony-cn@outlook.com>

ENV DISPLAY=":1"

RUN apk add --no-cache --update netcat-openbsd busybox-extras sudo python3 git bash supervisor xvfb x11vnc openbox socat xterm msttcorefonts-installer fontconfig wine feh\
  && update-ms-fonts \
